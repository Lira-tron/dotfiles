...
- **Knowledge Base**: `~/.gemini/knowledge/summary/{YYYY}/`
- **Year Index**: `~/.gemini/knowledge/summary/{YYYY}/index.md`
...
1. **Check if file exists**: `~/.gemini/knowledge/summary/{YYYY}/{YYYY-MM-DD}-{project}.md`
2. **If file exists**:
...
**Save location:**
- Directory: `~/.gemini/knowledge/summary/{YYYY}/`
- Ensure directory exists (create if needed)

### Step 5: Update Year Index
Update or create the year index file.

**Index file location:** `~/.gemini/knowledge/summary/{YYYY}/index.md`
...
This summary is now searchable via /search in Gemini.
```
...
{
  "resources": [
    "skill://.gemini/skills/create-summary/SKILL.md"
  ]
}
```
...
gemini "Generate summary for user-authentication project"

# Generate summary from daily notes
gemini "Generate summary for api-optimization from my notes"

# Generate summary for specific date range
gemini "Generate summary for database-migration from January 1-15"
```
