...
## File Structure
Store files in: `~/.gemini/knowledge/plans/{YY}/{MM}/{component}/{feature}/`
...
`~/.gemini/knowledge/plans/{YY}/{MM}/{component}/{feature}/`
...
{
  "resources": [
    "skill://.gemini/skills/create-plan/SKILL.md"
  ]
}
```
...
gemini "Create plan for user authentication with OAuth2"

# Create a plan for a component
gemini "Plan implementation of payment processing service"
```
