...
description: Guidelines for creating clear, effective engineering design documents with structured templates, sections, and best practices
tags: ["design", "documentation", "best-practices", "guidelines", "steering"]
inclusion: auto
version: 1.0.0
---
...
When the user asks to create a design, follow a structured workflow with explicit approval gates.
...
- Link to tracking items (issues, tickets)
...
- Design is modified or iterated
- User asks questions or provides clarifications
- Any review or approval gate is reached
