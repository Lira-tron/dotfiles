return {
    ...
    config = function()
        ...
        vim.keymap.set('n', '<leader>si', builtin.git_files, { desc = 'Search [G]it [F]iles' })
        vim.keymap.set('n', '<leader>ss', builtin.git_status, { desc = 'Search [G]it [S]tatus' })
        vim.keymap.set('n', '<leader>sc', builtin.git_commits, { desc = 'Search [G]it [L]og' })
