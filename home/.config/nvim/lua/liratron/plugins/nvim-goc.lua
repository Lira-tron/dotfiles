return {
    ...
    config = function ()
        ...
        vim.keymap.set('n', '<Leader>gct', goc.CoverageFunc, {silent=true}, { desc = "Coverage: run only for a specific Test unit" })
        vim.keymap.set('n', '<Leader>gcc', goc.ClearCoverage, {silent=true}, { desc = "Coverage: clear coverage highlights"})
        ...
        vim.keymap.set('n', ']a', goc.Alternate, {silent=true}, { desc = "Coverage: set verticalSplit=true for horizontal"})
        vim.keymap.set('n', '[a', goc.AlternateSplit, {silent=true}, { desc = "Coverage: set verticalSplit=true for vertical"})
        ...
        vim.keymap.set('n', '<Leader>gcb', function() cf(true) end, {silent=true}, { desc = "Coverage: Open coverage in browser current Function"})
