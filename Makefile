...
BREW_PACKAGES        := stow tmux ripgrep wget jq fd lua-language-server exa bat tree htop miller glow lazygit node@20 helm kubectl derailed/k9s/k9s awscli neovim yaml-language-server go yq fzf starship

all:: install-neovim link install-terminfo
